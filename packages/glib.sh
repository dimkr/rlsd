...
PACKAGE_SOURCES="http://ftp.gnome.org/pub/gnome/sources/glib/1.2/glib-$PACKAGE_VERSION.tar.gz https://projects.archlinux.org/svntogit/packages.git/plain/trunk/glib1-autotools.patch?h=packages/glib,glib1-autotools.patch https://projects.archlinux.org/svntogit/packages.git/plain/trunk/gcc340.patch?h=packages/glib,gcc340.patch https://projects.archlinux.org/svntogit/packages.git/plain/trunk/aclocal-fixes.patch?h=packages/glib,aclocal-fixes.patch"
