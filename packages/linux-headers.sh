...
package() {
	...
	install -D -m 644 README "$1/usr/share/doc/linux-headers/README"
	install -m 644 COPYING "$1/usr/share/doc/linux-headers/COPYING"
	install -m 644 CREDITS "$1/usr/share/doc/linux-headers/CREDITS"
	install -m 644 MAINTAINERS "$1/usr/share/doc/linux-headers/MAINTAINERS"
}
